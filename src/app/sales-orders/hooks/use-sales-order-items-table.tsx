import type { SalesOrderItemsTableDef } from "../components/sales-order-items-table";
...
export const useSalesOrderItemsTable = () => {
  const [openDialog, setOpenDialog] = useState<null | "remove-alert" | "edit-form">(null);
  const [editData, setEditData] = useState<null | SalesOrderItemsTableDef>(null);
  const columnHelper = createColumnHelper<SalesOrderItemsTableDef>();

  const handleEditClick = (defaultValues: SalesOrderItemsTableDef): void => {
