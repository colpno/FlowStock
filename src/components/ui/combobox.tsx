  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn(
        ...
        "focus-within:ring-2",
        "focus-within:ring-primary-container",

        // Invalid
        "has-aria-invalid:border-destructive",
        "has-aria-invalid:ring-2",
        "has-aria-invalid:ring-destructive",

        // Disabled (optional, if children can be disabled)
